...
export default function ChatHistory({ previousChats, onSelect }: {
        ...
        {previousChats.map((chat) => (
          ...
          >
            <div className="flex items-center justify-between">
              <span className="font-semibold text-neutral truncate max-w-[200px]">{chat.title}</span>
              <span className="text-xs text-light ml-2 whitespace-nowrap">{chat.time}</span>
            </div>
