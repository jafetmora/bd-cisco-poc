const threads = [
  ...
  {
    id: 3,
    title: "Who's assigned to my highest-value...",
    active: false,
  },
];
...
export default function ThreadsMenu() {
  return (
    <nav className="flex flex-col gap-2">
      <h2 className="font-segoe text-primary text-lg px-4 pt-4 pb-2">
        Threads
      </h2>
      {threads.map((thread) => (
        <a
        ...
        >
          ...
          <svg
            className={`w-5 h-5 ${thread.active ? "text-primary" : "text-light"}`}
            fill="none"
            stroke="currentColor"
            strokeWidth={2}
            viewBox="0 0 24 24"
          >
            <path
              ...
              d="M17 8h2a2 2 0 012 2v8a2 2 0 01-2 2H7a2 2 0 01-2-2v-2M15 3H9a2 2 0 00-2 2v12a2 2 0 002 2h6a2 2 0 002-2V5a2 2 0 00-2-2z"
            />
          </svg>
