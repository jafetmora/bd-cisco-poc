  ...
  return (
    <div className="flex items-center gap-6">
      ...
      <div className="relative">
        ...
        <span className="absolute top-1 right-1 bg-pink text-white rounded-full text-xs w-5 h-5 flex items-center justify-center border-2 border-white">2</span>
      </div>
      {/* Botão +Create */}
      ...
      <div className="relative w-64">
        ...
        />
        {/* Ícone de busca */}
        <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-accent" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
